...
int main() {
    ...
    int statusPrepod = 1;
    char* surnamePrepod = "Vasiliev";
    char* namePrepod = "Petr";
    char* patronymicPrepod = "Ivanovich";
    int departamentPrepod = 2;

    char* surnameStudent=  "Konstantinov";
    char* nameStudent = "Victor";
    int yearStudent = 2;
    int dep = 2;
    int group = 2;
    Prepod *p = new Prepod(departamentPrepod, surnamePrepod, namePrepod, patronymicPrepod, statusPrepod);
    Teacher *t = new Teacher(departamentPrepod, surnamePrepod, namePrepod, patronymicPrepod, statusPrepod, 1);
    t->students[0].setMan(Man(surnameStudent, nameStudent, yearStudent));
    t->students[0].setDepartament(dep);
    t->students[0].setNumberOfGroup(group);



    cout<<"Object teacher: "<<t->toString()<<endl;;
    cout<<"Object prepod: "<<p->toString()<<endl;
    cout<<"\n";
    Prepod* ptr_Prepod_to_Teacher = t;
    Teacher* ptr_Teacher_to_Teacher = t;
    cout<<"Pointer Prepod to Teacher: "<<ptr_Prepod_to_Teacher->toString()<<endl;
    cout<<"Pointer Teacher to Teacher: "<<ptr_Teacher_to_Teacher->toString()<<endl;
